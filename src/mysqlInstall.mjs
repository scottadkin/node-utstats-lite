...
`CREATE TABLE IF NOT EXISTS nstats_ctf_carry_times (
    ...
    `CREATE TABLE IF NOT EXISTS nstats_force_name_hwid_and_mac(
        ...
        mac2 varchar(32) NOT NULL,
        name varchar(32) NOT NULL,
        UNIQUE INDEX nfnhm_idx(hwid,mac1,mac2),
        PRIMARY KEY(id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;`,
...
export async function mysqlInstall(mysqlSettings){
    ...
    try{
        ...
        await connection.query(`CREATE DATABASE IF NOT EXISTS ${mysqlSettings.database} CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;`);
