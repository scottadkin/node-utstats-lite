...
export default class AdminJSONManager{
    ...
    async init(){
        ...
        try{
            ...
            if(this.mode === "load-importer-list"){
            ...
            }else if(this.mode === "restore-from-sqlite-backup"){

                if(this.req.body.backup === undefined) throw new Error("No backup selected");

                await restoreFromSQLiteBackup(this.req.body.backup);
                ...
                const result = await adminForceNameOnHWID(this.req.body.hwid, this.req.body.name);
            ...
            }else if(this.mode === "rename-force-hwid-to-name"){
                
                await adminRenameForceHWIDToName(this.req.body.hwid, this.req.body.name);
                return this.res.json({"message": "passed"});
                
            }else if(this.mode === "save-force-name-by-mac-addresses"){
            ...
            }else if(this.mode === "delete-force-mac-to-name"){
            ...
            }else if(this.mode === "delete-force-name-by-both"){
